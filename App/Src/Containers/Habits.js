...
class Habits extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      habitName: "",
      habitCategory: "",
      buttonOpacities: [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5],
  ...
  _selectCategory(id, category) {
    let highlights = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5];
    highlights[id] = 1;
  ...
  onSwipeRight() {
    this.props.user.habits.length
      ? Actions.camera()
      : Alert.alert("Please Add a Habit to Access the Camera!");
  }
  ...
  render() {
    ...
    const noHabitText = this.props.user.habits.length
      ? ""
    ...
    if (this.props.user.habits.length) {
      ...
      toDisplay = (
        <View style={[styles.noHabitText, noHabitStyle]}>
          ...
          >
            <Icon
              style={{ fontSize: 50, color: colors.primaryDark }}
              name="add-circle"
            />
          </Button>
        </View>
          ...
          >
            ...
            <View style={{ alignItems: "center" }}>
              <View style={styles.buttonGrid}>
                <View style={styles.buttonColumn}>
                  <View
                    style={[
                      ...
                      { opacity: this.state.buttonOpacities[0] }
                    ]}
                  >
                    <Button
                      ...
                      full
                      onPress={() => {
                        this._selectCategory(0, "Fitness");
                      }}
                    >
                  ...
                  <View
                    style={[
                      styles.categoryButton,
                      { opacity: this.state.buttonOpacities[1] }
                    ]}
                  >
                    <Button
                      style={{ backgroundColor: colors.secondaryDark }}
                      full
                      onPress={() => {
                        this._selectCategory(1, "Mindset");
                      }}
                    >
                  ...
                  <View
                    style={[
                      styles.categoryButton,
                      { opacity: this.state.buttonOpacities[2] }
                    ]}
                  >
                    <Button
                      style={{ backgroundColor: colors.secondaryDark }}
                  ...
                  <View
                    style={[
                      styles.categoryButton,
                      { opacity: this.state.buttonOpacities[3] }
                    ]}
                  >
                    <Button
                      style={{ backgroundColor: colors.secondaryDark }}
                      full
                      onPress={() => {
                        this._selectCategory(3, "Time Mgmt.");
                      }}
                    >
                ...
                <View style={styles.buttonColumn}>
                  <View
                    style={[
                      styles.categoryButton,
                      { opacity: this.state.buttonOpacities[4] }
                    ]}
                  >
                    <Button
                      style={{ backgroundColor: colors.secondaryDark }}
                  ...
                  <View
                    style={[
                      styles.categoryButton,
                      { opacity: this.state.buttonOpacities[5] }
                    ]}
                  >
                    <Button
                      style={{ backgroundColor: colors.secondaryDark }}
                      full
                      onPress={() => {
                        this._selectCategory(5, "Hygiene");
                      }}
                    >
                  ...
                  <View
                    style={[
                      styles.categoryButton,
                      { opacity: this.state.buttonOpacities[6] }
                    ]}
                  >
                    <Button
                      style={{ backgroundColor: colors.secondaryDark }}
                      full
                      onPress={() => {
                        this._selectCategory(6, "Sleeping");
                      }}
                    >
                  ...
                  <View
                    style={[
                      styles.categoryButton,
                      { opacity: this.state.buttonOpacities[7] }
                    ]}
                  >
                    <Button
                      style={{ backgroundColor: colors.secondaryDark }}
                      full
                      onPress={() => {
                        this._selectCategory(7, "Reading");
                      }}
                    >
              ...
              <View style={{ alignItems: "stretch", marginTop: 15 }}>
                <Button
                  style={{ backgroundColor: colors.primary, width: 300 }}
                  full
                  onPress={() => {
                    this._submitHabit();
                  }}
